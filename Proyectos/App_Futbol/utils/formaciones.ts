...
export const FORMACIONES: Formacion[] = [
  {
    id: '4-4-2',
    ranuras: [
      { x: 0.5, y: 0.895, rol: 'POR' },
      { x: 0.15, y: 0.715, rol: 'DEF' },
      { x: 0.38, y: 0.745, rol: 'DEF' },
      { x: 0.62, y: 0.745, rol: 'DEF' },
  ...
  },
  {
    ...
    ranuras: [
      { x: 0.5, y: 0.895, rol: 'POR' },
      // Central y pivote comparten la columna x = 0.5, así que necesitan el
      // mayor hueco vertical de toda la formación.
      { x: 0.26, y: 0.7, rol: 'DEF' },
      { x: 0.5, y: 0.745, rol: 'DEF' },
      { x: 0.74, y: 0.7, rol: 'DEF' },
      { x: 0.09, y: 0.56, rol: 'MED' },
      { x: 0.31, y: 0.48, rol: 'MED' },
      { x: 0.5, y: 0.575, rol: 'MED' },
      { x: 0.69, y: 0.48, rol: 'MED' },
      { x: 0.91, y: 0.56, rol: 'MED' },
      { x: 0.35, y: 0.24, rol: 'DEL' },
      { x: 0.65, y: 0.24, rol: 'DEL' },
    ],
  },
  {
    ...
    ranuras: [
      ...
      { x: 0.3, y: 0.745, rol: 'DEF' },
      { x: 0.5, y: 0.745, rol: 'DEF' },
      { x: 0.7, y: 0.745, rol: 'DEF' },
      { x: 0.9, y: 0.695, rol: 'DEF' },
      { x: 0.26, y: 0.48, rol: 'MED' },
      { x: 0.5, y: 0.6, rol: 'MED' },
      { x: 0.74, y: 0.48, rol: 'MED' },
      { x: 0.35, y: 0.24, rol: 'DEL' },
      { x: 0.65, y: 0.24, rol: 'DEL' },
    ],
  },
